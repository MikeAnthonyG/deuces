class Card:
    ...
    #This is my addition (Mikey)
    @staticmethod
    def int_to_strs(card_ints):
        list_ints = []
        for i in range(len(card_ints)):
            c = Card.int_to_str(card_ints[i])
            list_ints.append(c)
        return list_ints
    ...
    #(Mikey)
    @staticmethod
    def int_to_pretty_strs(card_ints):
        pretty_list = []
        for i in range(len(card_ints)):
            c = Card.int_to_pretty_str(card_ints[i])
            pretty_list.append(c)
        return pretty_list            
